import { styled, Paper, AppBar, Button, Card, TextField, Box, } from "@mui/material"
...
export const ListBox = styled(Box, { namae: 'ListBox' })(({ theme }) => ({
    padding: '0.5rem',
    marding: '0.25rem auto',
    backgroundColor: theme.palette.general.dark,
    display: 'flex',
...
// export const ListItemStyled = styled(ListItem, { namae: 'ListItemStyled' })(({ theme }) => ({
//     padding: '0.5rem',
//     marding: '0.5rem auto',
//     color: 'white',
//     border: '1px solid',
